...
cp get_next_line.c get_next_line.h get_next_line_utils.c gnlkiller/
cd gnlkiller/
./run.sh
cd ..
...
rm -rf gnlTester/ 42TESTERS-GNL/ gnlkiller/ 42cursus_gnl_tests/ gnl-war-machine-v2019/ GNL-lover
